...
-   Proximity to entrance/exit/bathrooms/kitchen/etc.; fixed physical location in lab
-   Accommodations
...
-   Simple Question 1 and 2 require granular desk selection (i.e. a preference for a specific desk, rather than a desk which meets certain qualifications), which may not be feasible?
